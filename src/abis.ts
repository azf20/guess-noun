// Generated by @wagmi/cli@0.1.15 on 5/14/2023 at 7:14:57 AM
import {
  getContract,
  GetContractArgs,
  readContract,
...
export function writeMessage<TFunctionName extends string>(
  ...
  return writeContract({ abi: messageABI, ...config } as WriteContractArgs<typeof messageABI, TFunctionName>)
}
...
export function prepareWriteMessage<TAbi extends readonly unknown[] = typeof messageABI, TFunctionName extends string = string>(
  ...
  return prepareWriteContract({ abi: messageABI, ...config } as unknown as PrepareWriteContractConfig<TAbi, TFunctionName>)
}
...
export function watchMessageEvent<TAbi extends readonly unknown[] = typeof messageABI, TEventName extends string = string>(
  ...
  return watchContractEvent({ abi: messageABI, ...config } as WatchContractEventConfig<TAbi, TEventName>, callback)
}
